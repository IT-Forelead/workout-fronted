<template>
  <div class="fixed inset-0 top-0 left-0 right-0 w-full h-screen overflow-x-hidden overflow-y-auto bg-slate-100 dark:bg-gray-900">
    <div class="w-full p-1 mx-auto mb-20 lg:mx-0 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:relative md:w-2/4 lg:top-1/2 lg:left-1/2 lg:p-4">
        ...
        <div class="p-3">
          <form>
            <div class="p-3">
              ...
              <div class="relative">
                <input id="password" :type="currentType" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900  focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
            ...
            <div class="flex items-center justify-end mt-5 p-5 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
