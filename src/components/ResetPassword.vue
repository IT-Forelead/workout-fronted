<template>
  <div
    ...
    <div class="relative mb-20 -translate-x-1/2 -translate-y-1/2 lg:mx-0 md:w-1/3 top-1/2 left-1/2 lg:p-4">
      <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div class="p-3">
          <div class="flex flex-col items-center justify-center pb-3 border-b border-gray-200 dark:border-gray-600">
            <div
              class="flex items-center justify-center my-2 mr-3 text-gray-500 bg-gray-100 border border-gray-200 rounded-md w-28 h-28 dark:bg-gray-800 dark:text-gray-700 dark:border-gray-600">
              <UserBoldIcon class="w-20 h-20" />
            </div>
            <p v-if="user" class="my-1 font-semibold text-gray-900 dark:text-gray-300">
              {{ user.firstname + ' ' + user.lastname }}
            </p>
            <p v-if="user" class="my-1 text-sm text-gray-600 dark:text-gray-400">{{ phoneStyle(user.phone) }}</p>
          </div>
