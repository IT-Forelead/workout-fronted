<template>
  <div class="bg-white h-20 py-4 sticky-top flex justify-between items-center z-10">
    <div class="ml-5 flex justify-between items-center">
      <div class="text-gray-900 mr-9">
      ...
      <div class="relative">
        ...
        <input type="search" name="search" class="bg-slate-100 text-slate-500 py-2 text-lg w-96 rounded-full border border-slate-300 pl-16 focus:outline-none focus:bg-slate-200 outline-none" placeholder="Izlash..." autocomplete="off" />
      </div>
    </div>
    <div class="mr-5 flex items-center">
      <button id="dropdownNotificationBtn" @click="toggleDropDownNotification()" class="inline-block relative bg-slate-100 text-slate-500 p-2 mr-3 rounded-full hover:bg-slate-200 shadow">
        <svg class="px-1 cursor-pointer" width="30" height="30" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="flex items-center mx-3">
        <button id="dropdownBtn" @click="toggleDropDown()" class="flex items-center" type="button">
          <div class="inline-block relative bg-slate-100 text-slate-500 p-2 rounded-full hover:bg-slate-200 shadow">
          ...
          <div class="flex items-center">
            <div class="text-left">
              <div class="text-lg font-semibold ml-2 px-2 cursor-pointer text-gray-900 capitalize">{{ fullname }}</div>
              <div class="text-md ml-2 px-2 cursor-pointer text-gray-500 capitalize">Admin</div>
            </div>
            <div class="bg-slate-50 text-slate-500 ml-2 p-1 rounded-full hover:bg-slate-100 border border-slare-200 shadow">
