  ...
  <div class="sticky-top z-10 flex h-16 md:h-20 items-center justify-between bg-white py-4 dark:bg-gray-800 dark:text-gray-300">
    <div class="ml-5 md:flex items-center justify-between">
      <div v-if="showSearchAndBtn">
        <ListIcon v-if="!sidebarStatus" @click="toggleSidebar()" class="menu-btn mr-5 cursor-pointer rounded-full p-1 text-4xl hover:text-blue-600 hover:shadow"/>
        <MenuIcon v-else @click="toggleSidebar()" class="menu-btn mr-5 cursor-pointer rounded-full p-1 text-4xl hover:text-blue-600 hover:shadow"/>
      </div>
    ...
    <div class="mr-5 flex items-center">
      ...
      <div class="md:mx-3 flex items-center" v-if="showSearchAndBtn">
        ...
        <div id="dropdownInformation"
          ...
          <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
            ...
            <li class="flex items-center justify-between px-3 py-2 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
              ...
              <label v-if="isLight" for="checked-toggle-off" class="inline-flex relative items-center cursor-pointer">
              ...
              <label v-else for="checked-toggle-on" class="inline-flex relative items-center cursor-pointer">
            ...
            <li class="hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
              <router-link to="/" @click="onLogout()" class="text-md flex items-center px-4 py-2 text-gray-700 dark:text-gray-300">
