      ...
      <div class="lg:gap-4 lg:flex">
        <div class="flex flex-col items-center justify-center md:py-24 lg:py-32">
          ...
          <router-link to="/login"
            class="px-6 py-2 mt-6 text-sm font-semibold text-blue-800 transition bg-blue-100 rounded hover:text-white hover:bg-indigo-500">Oldingi sahifaga qaytish</router-link>
        </div>
      </div>
    </div>
  </div>
