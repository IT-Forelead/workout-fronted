      ...
      <div class="flex items-center justify-between mb-5">
        ...
        <div class="relative hidden lg:flex lg:justify-between lg:items-center">
          ...
          <div v-if="openFilter" ref="filterDropdown" class="bg-white dark:bg-gray-800 border dark:border-gray-600 absolute top-11 right-0 z-30 dark:text-gray-300 w-1/4 mt-2 rounded-lg">
            <div @click="openFilter = false; filterData.typeBy = 'send-code'" class="px-3 py-2 border-b dark:border-gray-600 dark:hover:bg-gray-700 cursor-pointer">Aktivlash kodlari</div>
            <div @click="openFilter = false; filterData.typeBy = 'reminder'" class="px-3 py-2 dark:hover:bg-gray-700 cursor-pointer">Eslatma xabarlari</div>
          </div>
        </div>
      </div>
