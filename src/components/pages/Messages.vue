        ...
        <table class="w-full divide-y divide-gray-300">
          ...
          <tbody class="custom-height divide-y divide-gray-200 bg-white">
            <tr class="text-md text-gray-700">
              ...
              <td class="whitespace-nowrap px-4 py-3">Sizning to'lov vaqtingizga 7 kundan oz muddat qoldi</td>
              <td class="whitespace-nowrap px-4 py-3"><span class="px-5 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-lg">Yetkazildi</span></td>
            </tr>
            <tr class="text-md text-gray-700">
              <td class="whitespace-nowrap px-4 py-3">
                <div class="flex items-center">
