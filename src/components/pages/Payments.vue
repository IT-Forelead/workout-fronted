        ...
        <div class="mb-5 flex justify-between items-center">
          ...
          <div class="relative hidden lg:flex lg:justify-between lg:items-center">
            ...
            <div v-if="openFilter" ref="filterDropdown" class="bg-white dark:bg-gray-800 border dark:border-gray-600 absolute top-11 right-0 z-30 dark:text-gray-300 w-1/4 mt-2 rounded-lg">
              <div @click="openFilter = false; filterData.typeBy = 'monthly'" class="px-3 py-2 border-b dark:border-gray-600 dark:hover:bg-gray-700 cursor-pointer">Oylik to'lovlar</div>
              <div @click="openFilter = false; filterData.typeBy = 'daily'" class="px-3 py-2 dark:hover:bg-gray-700 cursor-pointer">Kunlik To'lovlar</div>
            </div>
          </div>
        </div>
        <div v-show="payments.length > 0" :class="{ 'overflow-hidden': total / 10 <= 1 }" class="payments-wrapper overflow-x-auto grid grid-cols-1 border border-slate-200 rounded-lg shadow-lg dark:border-gray-600 payment-table-h">
      ...
      <div class="relative top-1/2 left-1/2 h-full w-full max-w-7xl -translate-x-1/2 -translate-y-1/2 p-4">
        <div class="relative rounded-lg bg-white shadow-lg dark:bg-gray-800 dark:text-gray-300">
          ...
          <div class="p-3">
            ...
            <p class="text-center font-bold my-3 capitalize">
