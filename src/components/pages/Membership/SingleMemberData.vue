  ...
  <div>
    <div
      ...
      <div v-for="(member, idx) in members" :key="idx" class="overflow-hidden bg-white shadow-md rounded-xl dark:bg-gray-800">
        ...
        <img v-else src="../../../assets/images/avatar.jpg" class="object-cover w-full h-40 duration-500 cursor-zoom-out hover:object-scale-down" alt="#">
        ...
        <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:text-gray-300">
          ...
          <div class="p-5">
            <div v-if="Object.keys(selectedMember).length !== 0"
              ...
              <img v-else src="../../../assets/images/avatar.jpg" class="w-48 h-48 mx-auto rounded md:mx-2" alt="#">
