  ...
  <tr v-for="(msg, index) in messages" :key="index" class="text-gray-700 text-md dark:text-gray-300 dark:bg-gray-800">
    <td class="px-4 py-3 whitespace-nowrap">
      <div class="flex items-center">
        ...
        <div>
          <p class="font-semibold text-gray-900 dark:text-gray-300">{{ msg?.user.firstname + " " + msg?.user.lastname }}
          </p>
    ...
    <td class="px-4 py-3 whitespace-nowrap"><span class="px-5 py-1 font-semibold leading-tight rounded-lg" :class="{
    ...
    }">{{ deliveryStatusTranslate(msg.message.deliveryStatus) }}</span></td>
  </tr>
